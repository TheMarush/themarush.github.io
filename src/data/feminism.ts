...
export const feminismIntro = `The people who need feminist arguments the most are rarely the ones who show up to hear them. That has always been the problem I wanted to solve. Not preaching to the already converted, but <strong>finding the language, the patience, and the angle that makes the conversation possible with someone who would otherwise walk out of the room</strong>. These entries trace how I have been trying to do that, from a middle school classroom to a public forum, across nearly a decade of thinking about what it actually takes to change a mind.`;
...
These were not abstractions I was explaining. They were <strong>the grammar I had grown up inside</strong>.`,
  ...
  },
  {
    ...
    body: `My pre-scientific paper, Pojetí feminismu ve středoevropském kulturním prostoru 21. století (Concepts of Feminism in the Central European Cultural Space of the 21st Century), was a comparative study of how feminist movements are understood, received, and politically instrumentalized across Czech Republic, Slovakia, Germany, Austria, and Poland. It traced the divergence between liberal and radical feminist frameworks and examined <strong>why the same word can be celebrated in one country and treated as a slur two borders over</strong>. A recurring finding was the post-communist factor: in countries with historical experience of Soviet-era state feminism, the word itself arrived pre-contaminated, associated with enforced ideology rather than emancipation, making grassroots feminist organizing structurally harder to establish and sustain.

The paper included a formal interview with <strong>Mgr. Tomáš Pavlas</strong>, founder of the Genderman initiative and lecturer in Critical Men's Studies at Charles University in Prague, which shaped my central argument: that <strong>without men as committed participants, gender equality remains structurally incomplete</strong>. Pavlas framed this not as charity toward feminism but as a matter of democratic obligation. In a patriarchal society, he observed, <strong>men carry louder voices for the same demands, and declining to use that advantage is itself a form of complicity</strong>.`,
  ...
  },
  {
    ...
    title: "Zimní Škola",
    meta: "Winter school",
    body: `At winter school, I gave a talk that deliberately refused the conventional frame. Rather than presenting patriarchy as a women's problem requiring women's solutions, <strong>I mapped the full system and the costs it imposes on everyone it touches</strong>. Yes, the gender pay gap. Yes, the pink tax. But also what the research literature documents with considerable consistency: that men socialized into hegemonic masculine norms are substantially more likely to suppress emotional distress, avoid professional help, and die by suicide at rates more than three times higher than women. A systematic review published in 2024 identified emotional restraint, self-reliance as a survival ideology, and <strong>the perceived incompatibility of mental illness with masculine identity</strong> as the primary mechanisms linking patriarchal norms to male suicidality.

<strong>The same value system that keeps women out of boardrooms keeps men out of therapy.</strong> It holds fathers to a provider role while making active caregiving socially legible only as deviation. It constructs vulnerability as feminine and therefore as failure, which means that any man who departs from emotional stoicism faces not only internal conflict but social sanction from other men enforcing the norm. The argument was not that men have it worse, but that a liberation movement which ignores half of its potential constituency is working against itself. <strong>Patriarchy is not a conspiracy of men against women. It is a set of rigid scripts that diminishes anyone who deviates from them.</strong>`,
...
Over time I began noticing a pattern in conversations with people who rejected or dismissed feminist framing. When <strong>the argument was delivered in a register they could not follow</strong>, or in a way that positioned them as the problem to be corrected, <strong>they received it as an attack rather than an invitation</strong>. The implication was not that feminist critique should be softened into incoherence, but that comprehensibility and patience are themselves political tools, and that <strong>the goal of changing minds requires meeting people where they actually are</strong>.

I also addressed what I see as a significant strategic liability in contemporary feminist organizing: fragmentation that substitutes internal distinction-making for external impact. There are genuine and <strong>important differences between feminist groups</strong>, including disagreements serious enough to justify separate organizing, such as the exclusion of trans women by some feminist associations. Where such differences cross a threshold of fundamental principle, forming distinct coalitions is not only natural but necessary. <strong>The problem arises when the energy of the movement is spent on internal boundary maintenance rather than on the shared goals</strong> that motivated it in the first place.

<strong class="key-statement">Coalition does not require agreement on everything. It requires agreement on enough.</strong>`,
